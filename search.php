                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            <h5 class="product-name"><a href="product-details.html"><?php echo $result['productName'];?></a></h5>
                                            <div class="price-box">
                                                <span class="price-regular"><?php echo $fm->format_currency($result['price']);?></span>
                                                <span class="price-old"><del>$29.99</del></span>
                                            </div>
                                            <div class="product-item-action">
                                                <a class="btn btn-cart" href="product-details.php?proid=<?php echo $result['productId'];?>"><i class="ion-bag"></i>Details</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- product grid end -->
