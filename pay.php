...
if (isset($_GET['gate']) && $_GET['gate'] == 'cash') {
    $method = 'cash';
}
                    ...
                    <div class="order-summary-details">
                        ...
                        <div class="order-summary-content">
                            ...
                            <div class="order-summary-table table-responsive text-center">
                                ...
                                <?php
                                if (isset($_GET['gate']) && $_GET['gate'] == 'momocode') {
                                    ?>
                                    <form action="payment_qrmomo.php" method="post">
                                        <input type="hidden" name="totalamount" value="<?php echo $gtotal; ?>">

                                        <button type="submit" name="captureWallet" class="btn btn__bg">Thanh toán QRCODE
                                            MOMO</button>
                                    </form>

                                <?php } ?>
                                <?php
                                if (isset($_GET['gate']) && $_GET['gate'] == 'momoatm') {
                                    ?>
                                    <form action="payment_qrmomo.php" method="post">
                                        <input type="hidden" name="totalamount" value="<?php echo $gtotal; ?>">

                                        <button type="submit" name="payWithATM" class="btn btn__bg">Thanh toán ATM
                                            MOMO</button>
                                    </form>
